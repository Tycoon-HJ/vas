  ...
  <div>
    <div class="container">
      <svg height="200" viewBox="0 0 500 200" width="500">
        ...
        -->
        <rect class="rect" fill="none" height="50" stroke="#d1d3d7" stroke-width="2" transform="matrix(2 1 -1 2 50 0)" width="100" x="0"
              y="0"></rect>
      </svg>

      <div class="container">
        <svg height="440" viewBox="0 0 440 440" width="440">
          <circle cx="220" cy="220" fill="none" r="200" stroke="#d1d3d7" stroke-width="20"></circle>
          <circle class="circle" cx="220" cy="220" fill="none" r="200" stroke="#00a5e0" stroke-width="20"
      ...
      <div class="container">
        <svg height="200" viewBox="0 0 200 200" width="200">
          <rect fill="none" height="200" stroke="grey" stroke-width="8" width="200" x="0" y="0"></rect>
          <rect class="rect-process" fill="none" height="200" stroke="blue" stroke-width="8" transform="matrix(0 1 -1 0 200 0)" width="200" x="0"
                y="0"></rect>
        </svg>
      </div>
    </div>
    ...
    <div class="container">
      <svg class="line-container" height="400" viewBox="0 0 400 400" width="400">
        <line class="line" fill="none" stroke="red" stroke-width="20" x1="0" x2="400" y1="20" y2="20"></line>
        /
      </svg>
    </div>
    ...
    <div class="container">
      <svg height="200" width="200">
        <rect fill="red" height="50" width="100" x="0" y="0">
          <set attributeName="x" attributeType="XML" begin="1s" to="10"></set>
          <set attributeName="x" attributeType="XML" begin="2s" to="20"></set>
          <set attributeName="fill" attributeType="XML" begin="2s" to="blue"></set>
        </rect>
      </svg>
    </div>
    ...
    <div class="container">
      <svg height="200" width="200">
        <circle cx="0" cy="0" r="30" stroke="black" stroke-width="1">
          ...
          <!--                   repeatCount="indefinite"></animate>-->
          <animateTransform attributeName="transform" attributeType="XML" begin="0" dur="3s" from="1" repeatCount="indefinite"
                            to="2" type="scale"></animateTransform>
    ...
    <div class="container">
      <svg height="400" width="400">
        <polygon fill="#fcc" points="30 30 70 30 90 70 10 70" stroke="black">
          <animate attributeName="points" attributeType="XML" dur="5s" fill="freeze" repeatCount="1"
      ...
      <svg height="200" width="200">
        <rect fill="red" height="10" width="10" x="0" y="0">
          ...
          <animateMotion
              ...
              rotate="0"
          ></animateMotion>
          <animate id="red-to-blue" attributeName="fill" attributeType="XML" begin="0; blue-to-red.end+0.5s" dur="2s" fill="freeze" from="red"
                   to="blue"></animate>
          <animate id="blue-to-red" attributeName="fill" attributeType="XML" begin="red-to-blue.end+0.5s" dur="2s" fill="freeze" from="blue"
                   to="red"></animate>
    ...
    <div class="container">
      <svg height="200" viewBox="0 0 200 200" width="200">
        <g id="rect1">
          <rect fill="red" height="100" rx="0" ry="0" width="100" x="0" y="0">
            <animate
                attributeName="fill"
                attributeType="XML"
                begin="rect1.click"
        ...
        <animateTransform
            ...
            type="translate"
        />
        <rect fill="blue" height="100" width="100" x="0" y="100">
          <animate
              attributeName="fill"
              attributeType="XML"
              begin="rect1.click"
    ...
    <div class="container bg-grey">
      <svg height="400" width="400">
        <defs>
          <mask id="test-mask">
            <rect fill="green" height="390" width="390" x="5" y="5"></rect>
          </mask>
        ...
        <circle cx="200" cy="200" fill="url(#test-radialGradient)" r="150"></circle>
